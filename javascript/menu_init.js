...
var blink_cnt=0;
var list = ['files/images/menu_img/star2.png','files/images/menu_img/star3.png','files/images/menu_img/star4.png','files/images/menu_img/star3.png','files/images/menu_img/star2.png'];
...
function menu_play(){
	menu = new Audio("files/images/menu_img/menu.wav");
	menu.volume = 0.2;	
	menu.play();
}
function blink_star(){
...
function vanish(){
	container.style.backgroundImage = 'url(files/images/menu_img/background.jpg)';	
